...
class REST {
    ...
    protected $aa_name = null;
    protected $aa_user = null;
    ...
    public function initialize($config) {
        ...
        isset($config['aa_name']) && $this->aa_name = $config['aa_name'];
        isset($config['aa_key']) && $this->aa_key = $config['aa_key'];
    ...
    protected function _call($method, $uri, $params = array(), $format = NULL) {
        ...
        if ($this->aa_name != '') {
            $this->_ci->curl->http_header($this->aa_name, $this->aa_key);
        }
